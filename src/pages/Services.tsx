          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-church-accent rounded-lg p-8 flex">
              ...
              <div>
                ...
                <p className="text-church-primary font-medium mb-4">8:45 AM - 11:30 AM</p>
            ...
            <div className="bg-church-accent rounded-lg p-8 flex">
              ...
              <div>
                ...
                <p className="text-church-primary font-medium mb-4"> Every third Sunday of the month 8:45 AM - 11:30 AM</p>
                <p className="text-gray-700 mb-4">
